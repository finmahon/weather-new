...
function dlDataRoute() {
    ...
    dlData.get('/current', function (req, res) {
        ...
        out = [];
        JSDOM.fromURL("http://www.dlhweather.com/current-details/", {}).then(dom => {
    ...
    dlData.get('/wind', function (req, res) {
        ...
        console.log(new Date(), 'In dqqqqe POST / req.body=', req.body);

        JSDOM.fromURL("http://www.dlhweather.com/6hr-wind-graph/6hr-wind-data/", {}).then(dom => {
